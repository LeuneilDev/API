...
class UpdateOrderInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($method == 'PUT') {
            ...
            return [
                'invoiceNo' => ['sometimes', 'required|nullable'],
                'agentCode' => ['sometimes', 'required|nullable'],
                'senderName' => ['sometimes', 'required'],
                'senderAddress' => ['sometimes', 'required'],
                'senderContact' => ['sometimes', 'required'],
                'senderEmail' => ['sometimes', 'required|email'],
                'receiverName' => ['sometimes', 'required'],
                'receiverAddress' => ['sometimes', 'required'],
                'receiverContact' => ['sometimes', 'required'],
                'receiverEmail' => ['sometimes', 'required|email'],
                'destination' => ['sometimes', 'required'],
                'requestStatus' => ['sometimes', 'required'],
                'requestInfoAt' => ['sometimes', 'required'],
                'orderStatus' => ['sometimes', 'required|nullable'],
                'orderStatusAt' => ['sometimes', 'required'],
                'declaredValue' => ['sometimes', 'required'],
                'totalValue' => ['sometimes', 'required'],
                'totalPayment' => ['sometimes', 'required'],
